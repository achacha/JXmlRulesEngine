 ...
 * Number equals
 */
public class CompareTypeNumberBetweenInclusive extends CompareType
{
  /** Serial id */
  private static final long serialVersionUID = 1L;

  /** Compare type */
  public static final String TYPE = "NumberBetweenInclusive";
  ...
  public boolean evaluate(RuleContext ruleContext)
  {
    ...
    // int lowerBound = lhs.compareTo(lower);
    // int upperBound = lhs.compareTo(upper);
    // boolean result = (lowerBound > 0 && upperBound < 0) || 0 == lowerBound || 0 == upperBound;
